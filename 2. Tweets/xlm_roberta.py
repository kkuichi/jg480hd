from transformers import XLMRobertaTokenizerFast, XLMRobertaForSequenceClassification, Trainer, TrainingArguments
...
# Nacitanie datasetu
dataset = load_dataset("data", data_files={"train": "train.json", "test": "test.json"})
